...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center p-[17px] bg-[#0f0f0f] text-white">
      <Link className="items-center gap-3 text-3xl" to={"/"}>
      ...
      >
        <input
          className=" px-4 py-1 rounded outlne-none"
          placeholder="Ara"
          type="text"
        />
        <button className=" mr-2 text-2xl rounded full p-1 transition duration-300 hover: bg-grey-300">
          <AiOutlineSearch />
        </button>
      </form>
